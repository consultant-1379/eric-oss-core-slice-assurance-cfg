 ...
 */
public class ServiceUnavailableException extends HttpProblemException {

    /**
     * Constructs a {@code ServiceUnavailableException}.
     *
     ...
     */
    @Builder
    public ServiceUnavailableException(final String description, final String instance, final String type) {
