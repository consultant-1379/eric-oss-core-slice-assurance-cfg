 ...
 */
public class InternalServerErrorException extends HttpProblemException {

    /**
     * Constructs an {@code InternalServerErrorException}.
     *
     ...
     */
    @Builder
    public InternalServerErrorException(final String description, final String instance, final String type) {
