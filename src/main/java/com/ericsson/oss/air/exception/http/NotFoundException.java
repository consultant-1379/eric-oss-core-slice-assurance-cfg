 ...
 */
public class NotFoundException extends HttpProblemException {

    /**
     * Constructs a {@code NotFoundException}.
     *
     ...
     */
    @Builder
    public NotFoundException(final String description, final String instance, final String type) {
