...
*/ -}}
{{- define "eric-oss-core-slice-assurance-cfg.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-core-slice-assurance-cfg.mergeAnnotations" -}}
  {{- include "eric-oss-core-slice-assurance-cfg.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-core-slice-assurance-cfg.mergeLabels" -}}
  {{- include "eric-oss-core-slice-assurance-cfg.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
